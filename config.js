...
const ENEMY_TYPES=[
  ...
  // ── 精英5种 ──
  {key:'roller',    name:'卷der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#FF4500',sz:45,hpBase:28,  spdBase:0.72,atk:0.75,hasKB:true, unlockSec:0,special:'elite'},
  {key:'berserker', name:'狂der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#FF2020',sz:45,hpBase:35,  spdBase:0.70,atk:0.85,hasKB:true, unlockSec:0,special:'elite'},
  {key:'rich',      name:'壕der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#FFB800',sz:42,hpBase:18,  spdBase:0.52,atk:0.46,hasKB:false,unlockSec:0,special:'shield',immuneDot:true},
  {key:'lazy',      name:'废der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#CC2020',sz:47,hpBase:38,  spdBase:0.30,atk:0.90,hasKB:false,unlockSec:0,special:'elite'},
  {key:'brute',     name:'猛der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#CC1010',sz:55,hpBase:55,  spdBase:0.45,atk:1.10,hasKB:true, unlockSec:0,special:'elite',defMult:1.5},
];
...
const BOSS_DEFS=[
  // ── Boss1：假筑基 ──
  {
    key:'fake_zhuji',name:'筑基失败的假筑基',hp:4000,spd:0.55,sz:144,col:'#C97B3A',reward:4,
    _rageRequire:0,
  ...
  // ── Boss2：伪筑基 ──
  {
    key:'fake_skill',name:'卡瓶颈的伪筑基',hp:5500,spd:0.68,sz:135,col:'#8040A8',reward:5,
    _rageRequire:0,
  ...
  // ── Boss3：老掉牙 ──
  {
    key:'old_teeth',name:'老掉牙的筑基初期',hp:7000,spd:0.35,sz:153,col:'#888870',reward:5,
    _rageRequire:0,
  ...
  // ── Boss4：带法宝 ──
  {
    key:'has_treasure',name:'带法宝的筑基初期',hp:8000,spd:0.60,sz:144,col:'#C0901A',reward:6,
    _rageRequire:0,
  ...
  // ── Boss5：有后台 ──
  {
    key:'has_backing',name:'有后台的筑基初期',hp:9500,spd:0.65,sz:153,col:'#4060A0',reward:7,
    _rageRequire:0,
  ...
  // ── Boss6：吃不停 ──
  {
    key:'always_eat',name:'吃不停的筑基中期',hp:11000,spd:0.58,sz:162,col:'#A05828',reward:8,
    _rageRequire:1,
    ...
    update(G,boss){
      ...
      boss.sz=162+Math.floor((1-pct)*72);
    }
  },
  // ── Boss7：娇滴滴 ──
  {
    key:'dainty',name:'娇滴滴的筑基中期',hp:10000,spd:0.62,sz:135,col:'#E060A0',reward:8,
    _rageRequire:0,
  ...
  // ── Boss8：我爸是紫府 ──
  {
    key:'dad_zifu',name:'我爸是紫府的筑基中期',hp:13000,spd:0.60,sz:153,col:'#6030C0',reward:9,
    _rageRequire:2,
  ...
  // ── Boss9：爱发vlog ──
  {
    key:'vlogger',name:'爱发vlog的筑基后期',hp:12500,spd:0.65,sz:135,col:'#E04020',reward:10,
    _rageRequire:0,
  ...
  // ── Boss10：功法霸道 ──
  {
    key:'dominator',name:'功法霸道的筑基后期',hp:15000,spd:0.55,sz:162,col:'#203080',reward:11,
    _rageRequire:3,
  ...
  // ── Boss11：壕气冲天 ──
  {
    key:'rich_armor',name:'壕气冲天的筑基后期',hp:16000,spd:0.58,sz:171,col:'#C8A000',reward:12,
    _rageRequire:0,
  ...
  // ── Boss12：作威作福（终Boss）──
  {
    key:'tyrant',name:'作威作福的半步紫府',hp:20000,spd:0.50,sz:198,col:'#802010',reward:20,
    _rageRequire:4,
