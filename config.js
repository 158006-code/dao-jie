...
const ENEMY_TYPES=[
  // ── 普通14种 ──
  // 初期
  {key:'normal',    name:'逊der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#B04040',sz:10,hpBase:2.5, spdBase:0.58,atk:0.38,hasKB:false,unlockSec:0,special:null},
  {key:'lied',      name:'躺der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#8B5030',sz:14,hpBase:12,  spdBase:0.25,atk:0.80,hasKB:true, unlockSec:0,special:'lied'},
  ...
  {key:'hard',      name:'硬der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#607090',sz:16,hpBase:10,  spdBase:0.34,atk:0.65,hasKB:true, unlockSec:0,special:'armored',defMult:2.5},
  // 中期
  ...
  {key:'sly',       name:'苟der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#7060A0',sz:9, hpBase:4,   spdBase:0.48,atk:0.42,hasKB:false,unlockSec:0,special:'ranged',keepDist:130},
  // 后期
