...
const BOSS_DEFS=[
  // ── Boss1：假筑基 ──
  {
    key:'fake_zhuji',name:'筑基失败的假筑基',hp:4000,spd:0.55,sz:320,col:'#C97B3A',reward:4,
    _rageRequire:0,
  ...
  // ── Boss2：伪筑基 ──
  {
    key:'fake_skill',name:'卡瓶颈的伪筑基',hp:5500,spd:0.68,sz:300,col:'#8040A8',reward:5,
    _rageRequire:0,
  ...
  // ── Boss3：老掉牙 ──
  {
    key:'old_teeth',name:'老掉牙的筑基初期',hp:7000,spd:0.35,sz:340,col:'#888870',reward:5,
    _rageRequire:0,
  ...
  // ── Boss4：带法宝 ──
  {
    key:'has_treasure',name:'带法宝的筑基初期',hp:8000,spd:0.60,sz:320,col:'#C0901A',reward:6,
    _rageRequire:0,
  ...
  // ── Boss5：有后台 ──
  {
    key:'has_backing',name:'有后台的筑基初期',hp:9500,spd:0.65,sz:340,col:'#4060A0',reward:7,
    _rageRequire:0,
  ...
  // ── Boss6：吃不停 ──
  {
    key:'always_eat',name:'吃不停的筑基中期',hp:11000,spd:0.58,sz:360,col:'#A05828',reward:8,
    _rageRequire:1,
  ...
  // ── Boss7：娇滴滴 ──
  {
    key:'dainty',name:'娇滴滴的筑基中期',hp:10000,spd:0.62,sz:300,col:'#E060A0',reward:8,
    _rageRequire:0,
  ...
  // ── Boss8：我爸是紫府 ──
  {
    key:'dad_zifu',name:'我爸是紫府的筑基中期',hp:13000,spd:0.60,sz:340,col:'#6030C0',reward:9,
    _rageRequire:2,
  ...
  // ── Boss9：爱发vlog ──
  {
    key:'vlogger',name:'爱发vlog的筑基后期',hp:12500,spd:0.65,sz:300,col:'#E04020',reward:10,
    _rageRequire:0,
  ...
  // ── Boss10：功法霸道 ──
  {
    key:'dominator',name:'功法霸道的筑基后期',hp:15000,spd:0.55,sz:360,col:'#203080',reward:11,
    _rageRequire:3,
  ...
  // ── Boss11：壕气冲天 ──
  {
    key:'rich_armor',name:'壕气冲天的筑基后期',hp:16000,spd:0.58,sz:380,col:'#C8A000',reward:12,
    _rageRequire:0,
  ...
  // ── Boss12：作威作福（终Boss）──
  {
    key:'tyrant',name:'作威作福的半步紫府',hp:20000,spd:0.50,sz:440,col:'#802010',reward:20,
    _rageRequire:4,
