...
const ENEMY_TYPES=[
  // ── 普通14种 ──
  // 初期
  {key:'normal',    name:'逊der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'chase_group3'}],col:'#B04040',sz:10,hpBase:2.5, spdBase:0.58,atk:0.38,hasKB:false,unlockSec:0,special:null},
  {key:'lied',      name:'躺der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'burst_contact'}],col:'#8B5030',sz:14,hpBase:12,  spdBase:0.25,atk:0.80,hasKB:true, unlockSec:0,special:'lied'},
  {key:'cute',      name:'萌der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#E06080',sz:7, hpBase:1.5, spdBase:0.90,atk:0.20,hasKB:false,unlockSec:0,special:'swarm'},
  {key:'hard',      name:'硬der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'charge_invincible'}],col:'#607090',sz:16,hpBase:10,  spdBase:0.34,atk:0.65,hasKB:true, unlockSec:0,special:'armored',defMult:2.5},
  // 中期
  ...
  {key:'swift',     name:'快der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#E06030',sz:8, hpBase:1.2, spdBase:1.05,atk:0.24,hasKB:false,unlockSec:0,special:'fast'},
  {key:'poor',      name:'穷der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#806050',sz:10,hpBase:3,   spdBase:0.45,atk:0.35,hasKB:false,unlockSec:0,special:'fragile'},
  {key:'dumb',      name:'傻der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#9090A0',sz:11,hpBase:4,   spdBase:0.40,atk:0.38,hasKB:false,unlockSec:0,special:'random'},
  {key:'sly',       name:'苟der',    phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'arc_surround'},{hpScale:1.55,spdScale:1.18,behavior:'triple_shot'}],col:'#7060A0',sz:9, hpBase:4,   spdBase:0.48,atk:0.42,hasKB:false,unlockSec:0,special:'ranged',keepDist:130},
  // 后期
  ...
  // ── 精英5种 ──
  {key:'roller',    name:'卷der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#C86000',sz:13,hpBase:16,  spdBase:0.72,atk:0.75,hasKB:true, unlockSec:0,special:'elite'},
  {key:'berserker', name:'狂der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#AA2020',sz:13,hpBase:20,  spdBase:0.70,atk:0.85,hasKB:true, unlockSec:0,special:'elite'},
  {key:'rich',      name:'壕der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#C09020',sz:12,hpBase:8,   spdBase:0.52,atk:0.46,hasKB:false,unlockSec:0,special:'shield',immuneDot:true},
  {key:'lazy',      name:'废der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#8B2020',sz:14,hpBase:22,  spdBase:0.30,atk:0.90,hasKB:false,unlockSec:0,special:'elite'},
  {key:'brute',     name:'猛der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#702020',sz:18,hpBase:35,  spdBase:0.45,atk:1.10,hasKB:true, unlockSec:0,special:'elite',defMult:1.5},
];
