...
const ENEMY_TYPES=[
  ...
  // ── 精英5种 ──
  {key:'roller',    name:'卷der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#FF4500',sz:18,hpBase:16,  spdBase:0.72,atk:0.75,hasKB:true, unlockSec:0,special:'elite'},
  {key:'berserker', name:'狂der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#FF2020',sz:18,hpBase:20,  spdBase:0.70,atk:0.85,hasKB:true, unlockSec:0,special:'elite'},
  {key:'rich',      name:'壕der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#FFB800',sz:17,hpBase:8,   spdBase:0.52,atk:0.46,hasKB:false,unlockSec:0,special:'shield',immuneDot:true},
  {key:'lazy',      name:'废der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#CC2020',sz:19,hpBase:22,  spdBase:0.30,atk:0.90,hasKB:false,unlockSec:0,special:'elite'},
  {key:'brute',     name:'猛der精英',phase:[{hpScale:1.0,spdScale:1.0,behavior:'chase'},{hpScale:1.22,spdScale:1.08,behavior:'chase_group3'},{hpScale:1.55,spdScale:1.18,behavior:'dash_spawn'}],col:'#CC1010',sz:22,hpBase:35,  spdBase:0.45,atk:1.10,hasKB:true, unlockSec:0,special:'elite',defMult:1.5},
];
