...
function playSound(type){
  ...
  try{
    switch(type){
      ...
      case'water_click':zzfx(.3,.08,800,.01,.005,.03,1,2,0,0,0,0,0,0,0,.08,.02,0,0,.005);break;
      case'crit_drop':zzfx(.8,.25,200,.01,.02,.1,1,-4,0,0,0,0,0,0,0,.5,.15,.4,.05,.08);break;
      case'weapon_drop':zzfx(.7,.35,80,.02,.03,.2,1,-2,-3,0,0,0,0,0,0,.4,.12,.3,.05,.06);break;
      case'red_drop':zzfx(1,.5,40,.05,.1,.6,1,-.3,-5,0,0,0,0,0,0,.5,.2,.5,.1,.1);break;
      case'synth_success':zzfx(.5,.3,300,.05,.05,.15,0,1.5,0,0,200,.05,.1,0,0,0,.05,.5,0,.1);break;
      case'synth_fail':zzfx(.4,.15,200,.01,.01,.08,1,-.8,0,0,0,0,0,0,0,.3,.02,0,0,.02);break;
    }
  }catch(e){}
}
